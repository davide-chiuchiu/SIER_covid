...
function d_compartments = equations(~, compartments, parameters, equation_types)
    if strcmp(equation_types, 'crude_estimates') || strcmp(equation_types, 'suppressed_crude_estimates')
        ...
        d_compartments(1) = - parameters.beta * compartments(1) * compartments(3) / parameters.okinawa_population + ...
                            parameters.inbound_from_Naha_airport - parameters.outbound_from_Naha_airport * (compartments(1) + compartments(4)) / parameters.okinawa_population;
        d_compartments(2) = parameters.beta * compartments(1) * compartments(3) / parameters.okinawa_population - parameters.sigma * compartments(2) + ...
                            - parameters.outbound_from_Naha_airport * compartments(2) / parameters.okinawa_population;
        d_compartments(3) = parameters.sigma * compartments(2) - parameters.gamma * compartments(3) - parameters.outbound_from_Naha_airport * compartments(3) / parameters.okinawa_population;

function main(start_containment_date, equation_type, plot_results)
    ...
    [quantile_infections, quantile_severe_cases, quantile_deaths] = initialize_SEIR_batch(n_runs, time, tspan, json_name, SEIR_metaparameters, equation_type);

    summary(time, quantile_infections, quantile_severe_cases, quantile_deaths, max_ventilators,[equation_type ' containment started on ' datestr(start_containment_date)])

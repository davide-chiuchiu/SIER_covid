function R0_suppression_coefficient = suppression_policy(t, SEIR_parameters, SEIR_metaparameters, equation_type)
    ...
    elseif strcmp(equation_type, 'Flakman_containment')
        intervention_times = [0, SEIR_metaparameters.start_containment_date + [0, 2, 4, 6]];
        t1_suppression_case_isol_and_public_event_ban = (1 - SEIR_parameters.R0_supp_case_isolation) * (1 - SEIR_parameters.R0_supp_public_event_ban);

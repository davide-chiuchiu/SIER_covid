function [quantile_infections, quantile_severe_cases, quantile_deaths] = initialize_SEIR_batch(n_runs, time, tspan, json_name, SEIR_metaparameters)
    ...
    for i = 1 : n_runs
        ...
        [~ ,compartments] = SEIR(tspan, SEIR_parameters, SEIR_metaparameters);

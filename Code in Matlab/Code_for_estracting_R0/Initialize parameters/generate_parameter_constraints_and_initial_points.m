function [lower_bounds, upper_bounds, initial_points] = generate_parameter_constraints_and_initial_points(SEIR_metaparameters)
    ...
    mean_detection_percentage_lower_bound  = 0.07;
    lower_bounds = [R0_lower_bound, time_of_suppression_lower_bound, ...
                    ...
                    estimated_initial_exposed_lower_bound, mean_detection_percentage_lower_bound];
    ...
    estimated_initial_infected_upper_bound = 500;
    estimated_initial_exposed_upper_bound  = 500;
    mean_detection_percentage_upper_bound  = 0.2;
    upper_bounds = [R0_upper_bound, time_of_suppression_upper_bound, ...
                    ...
                    estimated_initial_exposed_upper_bound, mean_detection_percentage_upper_bound];    
    ...
    random_initial_conditions = repmat(lower_bounds, SEIR_metaparameters.random_points, 1) + rand(SEIR_metaparameters.random_points, 6) .* (repmat(upper_bounds, SEIR_metaparameters.random_points, 1) - repmat(lower_bounds, SEIR_metaparameters.random_points, 1));
